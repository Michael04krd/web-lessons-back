...
<body>
    <div class="admin-container">
        <h1>Админ-панель</h1>
        <a href="/web-lessons-back/project/modules/logout.php" class="button admin-logout">Выйти</a>
                ...
                <tr>
                    ...
                    <td class="buttons">
                        <div class="change_button">
                            <a href="/web-lessons-back/project/modules/edit.php?id=<?= $app['id'] ?>">Редактировать</a>
                        </div>
                        <button class="delete_button" onclick="if(confirm('Удалить эту заявку?')) location.href='/web-lessons-back/project/modules/delete.php?id=<?= $app['id'] ?>'">Удалить</button>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
